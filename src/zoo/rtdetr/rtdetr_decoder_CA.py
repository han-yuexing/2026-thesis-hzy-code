...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self,
        ...
        tgt3 = self.cross_attn(
            self.with_pos_embed(tgt_n, query_pos_embed), 
            # q,
            reference_points, 
            memory,
            memory_spatial_shapes, 
        ...
        k = self.with_pos_embed(tgt_n, query_pos_embed)
        ...
        tgt2, _ = self.self_attn(q, k, value=tgt_n, attn_mask=attn_mask)
        tgt = tgt_n + self.dropout1(tgt2)
        tgt = self.norm1(tgt)
