...
from .dyfpn import Attention_SEblock
...
class BlockBody(nn.Module):
    def __init__(self, channels=256):
        ...
        self.downsample_scalezero2_2 = Downsample_x2(channels, channels)
        self.downsample_scalezero2_4 = Downsample_x4(channels, channels)
        self.downsample_scaleone2_2 = Downsample_x2(channels, channels)
        self.upsample_scaleone2_2 = Upsample(channels, channels, scale_factor=2)
        self.upsample_scaletwo2_2 = Upsample(channels, channels, scale_factor=2)
        self.upsample_scaletwo2_4 = Upsample(channels, channels, scale_factor=4)

        self.asff_scalezero2 = ASFF_3(inter_dim=channels)
        self.asff_scaleone2 = ASFF_3(inter_dim=channels)
        self.asff_scaletwo2 = ASFF_3(inter_dim=channels)
        ...
        # self.downsample_scalezero3_2 = Downsample_x2(channels[0], channels)
        # self.downsample_scalezero3_4 = Downsample_x4(channels[0], channels)
        ...
        # self.downsample_scaleone3_2 = Downsample_x2(channels[1], channels)
        # self.downsample_scaleone3_4 = Downsample_x4(channels[1], channels[3])
        # self.upsample_scaletwo3_4 = Upsample(channels, channels[0], scale_factor=4)
        # self.upsample_scaletwo3_2 = Upsample(channels, channels[1], scale_factor=2)
        # self.downsample_scaletwo3_2 = Downsample_x2(channels, channels[3])
        ...
        # self.upsample_scalethree3_2 = Upsample(channels[3], channels, scale_factor=2)

        # self.asff_scalezero3 = ASFF_4(inter_dim=channels[0])
        # self.asff_scaleone3 = ASFF_4(inter_dim=channels[1])
        # self.asff_scaletwo3 = ASFF_4(inter_dim=channels)
...
class AFPN(nn.Module):
    def __init__(self,
        ...
        self.conv2 = BasicConv(in_channels, in_channels // 8, 1)
        self.conv3 = BasicConv(in_channels[3], in_channels[3] // 8, 1)

        self.body = nn.Sequential(
            BlockBody([in_channels[0] // 8, in_channels[1] // 8, in_channels // 8, in_channels[3] // 8])
        )

        self.conv00 = BasicConv(in_channels[0] // 8, out_channels, 1)
        self.conv11 = BasicConv(in_channels[1] // 8, out_channels, 1)
        self.conv22 = BasicConv(in_channels // 8, out_channels, 1)
